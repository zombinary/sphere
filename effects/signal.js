...
var color = 0;
var count = 0;
var CMD_SETRANGE = new Buffer([0x11,0x00,0x14,0x00,0x00,0x00,0x06,0x00,0xff,0x00,0x00]);
    	...
    	connect(function(){
    		...
    		if(led_on){
    			led_on = false;
					...
					led_on = true;
					CMD_SETRANGE[4] = 0x00;//0xfa / 20;
					CMD_SETRANGE[6] = 0x06;//0x00;
